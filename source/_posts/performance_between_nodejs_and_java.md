...
|--------|-----------|---------|--------|----------|----------|----------|-----|------|---------|------------|--------|
| java   | 10000     | 229     | 59     | 820      | 1052     | 1396     | 2   | 2059 | 0.03%   | 556.8      | 253.2  |
| nodejs | 10000     | 57      | 31     | 155      | 185      | 259      | 0   | 331  | 0.00%   | 577.4      | 104.3  |
| 总体   | 20000     | 143     | 44     | 360      | 820      | 1323     | 0   | 2059 | 0.02%   | 1113.5     | 353.8  |
...
这里主要看Throughput（吞吐量）这一列，可以看到nodejs和java在测试机器上每秒差不多都能处理560个请求，在这组中nodejs比java好了3%左右。但是我测试过多组，每次结果的吞吐量他们都差不多。这个结果比较意外，因为我测试这个的目的实际上想证明Nodejs在这方面会比Java的性能好一点的:(  
但是值得注意的是nodejs的平均响应时间比java小的多（那为啥吞吐量最终还差不多呢？）
